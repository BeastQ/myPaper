...
vConType =   'DiagCoeff';%% 'DiagCoeff';%%           %矢量构成方式Zigzag或者DiagCoeff
...
for i = 1 : imNum
    ...
    %orgImData = imread(strcat(orgImPath,num2str(i),orgImFormat));
     orgImData = imread(strcat(orgImPath,'lena512color',orgImFormat));
    % CMYK --> Lab
...
%     wA=round(wA);
    ...
    fprintf(fid1,'提取水印的载体图像位置:%s\r\n',strcat(orgImPath,'lena512color',orgImFormat))
